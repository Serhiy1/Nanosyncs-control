...
class NanoSync:
    def __init__(self):
        ...
        self.HD_standard = 1             # byte 3: 1080i = 1, 1080p = 2, 1080p x 2fps = 3, 720p = 4, 720p x 2fps = 5
    ...
    def update_current_config(self):
        ...
        self.video_config = [self.cursor_pos, self.video_ref, self.video_standard, self.HD_standard, self.FPS, self.video_1_to_3,
    ...
    def send_new_config(self, command):
        ...
        for i in range(5):
            ...
            self.get_current_config()
            if comparision != self.current_config:
    ...
    def print_current_config(self):
        ...
        byte_3 = ["1080i", "1080p", "1080p x 2fps", "720p", "720p x 2fps"]
        ...
        byte_names_list = ["cursor_pos", "video_ref = ", "video_standard = ", "HD_standard = ", "FPS = ", "video 1 - 3 = ",
    ...
    def test_function(self):
        ...
        test_command = test_file.readline()
        ...
        while True:
            if test_command == "END\n":
                ...
                for i in range(len(test_command)):
                    test_command[i] = int(test_command[i])

                self.send_new_config(test_command)
                test_command = test_file.readline()
